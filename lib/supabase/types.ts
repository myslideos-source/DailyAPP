    ...
    Tables: {
      ...
      user_preferences: {
        Row: {
          ...
          daily_briefing_auto_show: boolean
          daily_briefing_enabled: boolean
          daily_briefing_frequency: string
          daily_briefing_include_personal: boolean
          daily_briefing_include_shared: boolean
          has_onboarded: boolean
          last_daily_briefing_seen_date: string | null
          profile_id: string
          reduced_motion_override: boolean | null
          updated_at: string
          widget_hide_private_content: boolean
          widget_show_event_title: boolean
          widget_show_tasks: boolean
          widget_show_time_only: boolean
        }
        Insert: {
          calendar_filters?: Json
          daily_briefing_auto_show?: boolean
